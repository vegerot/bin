...
while true; do
    ...
    if echo $stat|grep yes ; then
        ...
        ~/Downloads/tsschecker-latest/tsschecker_macos -d iPhone9,3 -e D68E828E91526 -i 12.1.1 --beta -o -s -m $HOME/Downloads/1211b3/BuildManifest.plist --buildid 16C5050a --save-path ~/Desktop/long/
        rm -r /tmp/tsschecker
        rm /tmp/ota.json
